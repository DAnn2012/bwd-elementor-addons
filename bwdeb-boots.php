...
class BWDEBClassElementorBundle {
	...
	public function bwdeb_all_assets_for_the_public(){
		...
		$script_paths = ['imagesloaded.pkgd.min','isotope.pkgd.min','snake','search_main','author-bio','bwdeb-owl.carousel.min4','bwdeb.carousel.min5','bwdeb-caro','codentor-prism','tab','datatables','responsive'];
		...
		$stylefile = ['responsive-column','bwdeb-animate.min','bootstrap.min','bwdeb.theme.default.min','dual-buttons', 'swiper-bundle.min', 'animate.min', 'filterable-gallery-popup','tab', 'search_style', 'imsgroup', 'bwdeb-owl.carousel.min3', 'cmn'];
