...
if(get_option('bwdeb-plugin-meet-the-team','off')=='on'){
    wp_enqueue_style( 'bwdproeb-team-main2', plugin_dir_url( __FILE__ ) . '../assets/public/css/bwdeb-team-main2.css', null, BWDEB_PLUGIN_V, 'all' );
    wp_enqueue_script( 'bwdproeb-team-min', plugin_dir_url( __FILE__ ) . '../assets/public/js/min.js', array('jquery'), BWDEB_PLUGIN_V, true );
}
if(get_option('bwdeb-plugin-team-carousel','off')=='on' || get_option('bwdeb-plugin-team-carousel2','off')=='on'){
...
if(get_option('bwdeb-plugin-news-ticker','off')=='on'){
    wp_enqueue_style( 'bwdproeb-bwdeb-style2', plugin_dir_url( __FILE__ ) . '../assets/public/css/bwdeb-style2.css', null, BWDEB_PLUGIN_V, 'all' );
    wp_enqueue_script( 'bwdproeb-bwdeb-main8', plugin_dir_url( __FILE__ ) . '../assets/public/js/bwdeb-main8.js', array('jquery'), BWDEB_PLUGIN_V, true );
}
