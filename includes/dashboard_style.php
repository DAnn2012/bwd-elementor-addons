												...
												echo '<div id="tab2" class="tab-content">';
														echo '<div class="bwd-main-wrapper">';
																...
																echo '<div class="bwd-widget-item-wrapper">';
																	// For free
																		...
																		echo '<div class="bwd-sk-cmn bwd-single-widget-item '.$F_Single_W.'">';
																			...
																			echo '<a href="https://bwdplugins.com/plugins_documentations/wfpg_documentation/" class="bwd-dcmtn-link" target="_blank">';
																		...
																		echo '<div class="bwd-sk-cmn '.$if_no_pro.' '.$Check_active.'">';
																			...
																			echo '<div class="bwd-widget-box">';
																			echo '<a href="https://bwdplugins.com/plugins_documentations/li_documentation/" class="bwd-dcmtn-link" target="_blank">';
																			...
																			echo '<div class="bwd-switch-item '.$pro_Check.'">';
																				echo '<label class="bwd-switch">';
																				if(class_exists( 'ProbwdelementorBundle' )){ $Na1 = 'name="'.esc_attr($value).'" value="on"'; $Na2 = checked( get_option($value, 'off' ), 'on', false );}
																					echo '<input type="'.$E_checkbx.'"  '.$Na1.' '.$Na2.'>';
																					echo '<span class="bwd-slider"></span>';
																				echo '</label>';
																			echo '</div>';
																		echo '</div>';
															...
															echo '<div class="bwd-sk-wrapper">';
																	...
																	echo '<div class="bwd-widget-item-wrapper">';
																		...
																		echo '<div class="bwd-sk-cmn '.$if_no_pro.' '.$act_check.'">';
																			echo '<div class="bwdeb_pro_pro_per"><span>'.esc_html__('Pro', 'bwd-elementor-addons').'</span></div>';
																			echo '<div class="bwd-widget-box">';
																				echo '<a href="https://bwdplugins.com/plugins_documentations/bcvb_documentation/" class="bwd-dcmtn-link" target="_blank">';
																			...
																			echo '<div class="bwd-switch-item '.$pro_Check.'">';
																				echo '<label class="bwd-switch">';
																				if(class_exists( 'ProbwdelementorBundle' )){ $chE = 'name="'.esc_attr('bwdeb-plugin-cv-'.$cv_builder).'" value="on"'; $CheB = checked( get_option('bwdeb-plugin-cv-'.$cv_builder, 'off' ), 'on', false );}
																					echo '<input type="'.$E_checkbx.'" '.$chE.' '.$CheB.'>';
																					echo '<span class="bwd-slider"></span>';
																				echo '</label>';
																			echo '</div>';
																		echo '</div>';
															...
															echo '<div class="bwd-sk-wrapper">';
																...
																echo '<div class="bwd-widget-item-wrapper">';
																	...
																	echo '<div class="bwd-sk-cmn '.$if_no_pro.' '.$option_Ch.'">';
																		...
																		echo '<div class="bwd-switch-item '.$pro_Check.'">';
																			echo '<label class="bwd-switch">';
																			if(class_exists( 'ProbwdelementorBundle' )){ $name_Ch = 'name="'.esc_attr('bwdeb-check-hero-widget'.$i).'" value="on"'; $Ch_E = checked( get_option('bwdeb-check-hero-widget'.$i, 'off' ), 'on', false );}
																				echo '<input type="'.$E_checkbx.'" '.$name_Ch.' '.$Ch_E.'>';
																				echo '<span class="bwd-slider"></span>';
																			echo '</label>';
																		echo '</div>';
																	echo '</div>';
															...
															echo '<div class="bwd-sk-wrapper">';
																...
																echo '<div class="bwd-widget-item-wrapper">';
																	$post_wdgts = array('post-grid-elementor-addon' => 'post-grid', 'blog-post-list' => 'post-list', 'post-tiles' => 'post-tiles', 'blog-post-accordions' => 'post-accordion', 'post-timeline' => 'post-timeline', 'masonry-blog-post' => 'masonary-blog-post', 'post-image-accordion' => 'post-image-accordion', 'effective-post-slider' => 'single-post-slider', 'news-ticker' => 'news-ticker', 'post-carousel' => 'creative-post-carousel');
																	...
																	echo '<div class="bwd-sk-cmn bwd-single-widget-item '.$vaLue.'">';
																		echo '<div class="bwd-profree-badge">'.$String_of_free_pro.'</div>';
																		echo '<div class="bwd-widget-box">';
																			echo '<a href="https://bwdplugins.com/plugins_documentations/bpg_documentation/" class="bwd-dcmtn-link" target="_blank">';
																				echo '<p class="bwd-widget-title">'.esc_html__(ucwords(str_replace('-', ' ', $key)), 'bwd-elementor-addons').'</p>';
																				echo '<span class="bwd-view-demo">'.esc_html__('View Documentation', 'bwd-elementor-addons').'</span>';
																			echo '</a>';
																			echo '<a href="https://bestwpdeveloper.com/'.$key.'" class="bwd-demo-link" target="_blank">';
																	...
																	endforeach;
																	// Pro
																	$post_wdgtsPro = ['post-prestige-portfolio' => 'bwdeb-post-prestige-portfolio', 'advanced-posts-tab' => 'bwdeb-apostst'];
																	...
																	echo '<div class="bwd-sk-cmn '.$if_no_pro.' '.$value_CH.'">';
																		...
																		echo '<div class="bwd-switch-item '.$pro_Check.'">';
																			echo '<label class="bwd-switch">';
																			if(class_exists( 'ProbwdelementorBundle' )){ $n1 = 'name="'.esc_attr($value).'" value="on"'; $n2 = checked( get_option($value, 'off' ), 'on', false );}
																				echo '<input type="'.$E_checkbx.'" '.$n1.' '.$n2.'>';
																				echo '<span class="bwd-slider"></span>';
																			echo '</label>';
																		echo '</div>';
																	echo '</div>';
															...
															echo '<div class="bwd-sk-wrapper">';
																...
																echo '<div class="bwd-widget-item-wrapper">';
																	...
																	echo '<div class="bwd-sk-cmn bwd-single-widget-item '.$Val.'">';
																		echo '<div class="bwd-profree-badge">'.$String_of_free_pro.'</div>';
																		echo '<div class="bwd-widget-box">';
																			echo '<a href="https://bwdplugins.com/plugins_documentations/bcpg_documentation/" class="bwd-dcmtn-link" target="_blank">';
																				echo '<p class="bwd-widget-title">'.esc_html__(ucwords(str_replace('-', ' ', $value)), 'bwd-elementor-addons').'</p>';
																				echo '<span class="bwd-view-demo">'.esc_html__('View Documentation', 'bwd-elementor-addons').'</span>';
																			echo '</a>';
																			echo '<a href="https://bestwpdeveloper.com/'.$key.'" class="bwd-demo-link" target="_blank">';
																	...
																	$value_CH = (checked( get_option($value, 'off' ), 'on', false ))?esc_attr('active'):'';
																	echo '<div class="bwd-sk-cmn '.$if_no_pro; echo $value_CH.'">';
																		echo '<div class="bwdeb_pro_pro_per"><span>'.esc_html__('Pro', 'bwd-elementor-addons').'</span></div>';
																		echo '<div class="bwd-widget-box">';
																			echo '<a href="https://bwdplugins.com/plugins_documentations/bcvb_documentation/" class="bwd-dcmtn-link" target="_blank">';
																				echo '<p class="bwd-widget-title">'.esc_html__(ucwords(str_replace('-', ' ', $key)), 'bwd-elementor-addons').'</p>';
																		...
																		echo '<div class="bwd-switch-item '.$pro_Check.'">';
																			echo '<label class="bwd-switch">';
																			if(class_exists( 'ProbwdelementorBundle' )){ $NaM1 = 'name="'.esc_attr($value).'" value="on"'; $NaM2 = checked( get_option($value, 'off' ), 'on', false );}
																				echo '<input type="'.$E_checkbx.'" '.$NaM1.' '.$NaM1.'>';
																				echo '<span class="bwd-slider"></span>';
																			echo '</label>';
																		echo '</div>';
																	echo '</div>';
														...
														echo '<div class="bwd-widget-item-wrapper">';
															...
															echo '<div class="bwd-sk-cmn '.$if_no_pro.' '.$value_CH.'">';
																...
																echo '<div class="bwd-switch-item '.$Pro_p.'">';
																	echo '<label class="bwd-switch">';
																		if(class_exists( 'ProbwdelementorBundle' )){ $vn_name = 'name="'.esc_attr($value).'" value="on"'; $vn_get_v = checked( get_option($value, 'off' ), 'on', false );}
																		echo '<input type="'.$E_checkbx.'" '.$vn_name.' '.$vn_get_v.'>';
																		echo '<span class="bwd-slider"></span>';
																	echo '</label>';
																echo '</div>';
															echo '</div>';
