...
class BWDEB_BWDIMimageshape extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bwdplugins.com/bwd-image-shape/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
    ...
    protected function render() {
		...
		if ( ! empty( $settings['bwdim_image_link']['url'] ) ) {
			$this->add_link_attributes( 'bwdim_image_link', esc_url($settings['bwdim_image_link']) );
		}
		if ( ! empty( $settings['bwdim_image_shape_btn_link']['url'] ) ) {
			$this->add_link_attributes( 'bwdim_image_shape_btn_link', esc_url($settings['bwdim_image_shape_btn_link']) );
		}
