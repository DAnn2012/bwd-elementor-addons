	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/testimonial-addon-for-elementor/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Carousel Settings', 'bwdtbt-blogpost-td' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Custom Id', 'bwdtbt-blogpost-td' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'post-id', 'bwdtbt-blogpost-td' ),
			]
		);
		...
		$this->add_control(
			'bwdtbt_slide_margin',
			[
				'label' => esc_html__( 'Item Gap', 'bwdtbt-blogpost-td' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Responsive Device', 'bwdtbt-blogpost-td' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => esc_html__( 'Default', 'bwdtbt-blogpost-td' ),
				'label_on' => esc_html__( 'Custom', 'bwdtbt-blogpost-td' ),
				'return_value' => 'yes',
		...
		$this->start_popover();
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Desktop View', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::NUMBER,
					'min' => 1,
					'max' => 100,
					'step' => 1,
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Tablet View', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::NUMBER,
					'min' => 1,
					'max' => 100,
					'step' => 1,
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Mobile View', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::NUMBER,
					'min' => 1,
					'max' => 100,
					'step' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'More Controlls', 'bwdtbt-blogpost-td' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => esc_html__( 'Default', 'bwdtbt-blogpost-td' ),
				'label_on' => esc_html__( 'Custom', 'bwdtbt-blogpost-td' ),
				'return_value' => 'yes',
		...
		$this->start_popover();
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Autoplay', 'bwdtbt-blogpost-td' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => esc_html__( 'Show', 'bwdtbt-blogpost-td' ),
						'label_off' => esc_html__( 'Hide', 'bwdtbt-blogpost-td' ),
						'return_value' => 'yes',
						'default' => 'yes',
					]
				);
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Infinite Loop', 'bwdtbt-blogpost-td' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => esc_html__( 'Show', 'bwdtbt-blogpost-td' ),
						'label_off' => esc_html__( 'Hide', 'bwdtbt-blogpost-td' ),
						'return_value' => 'yes',
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Hover Pause', 'bwdtbt-blogpost-td' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => esc_html__( 'Show', 'bwdtbt-blogpost-td' ),
						'label_off' => esc_html__( 'Hide', 'bwdtbt-blogpost-td' ),
						'return_value' => 'yes',
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Center Mode', 'bwdtbt-blogpost-td' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => esc_html__( 'Show', 'bwdtbt-blogpost-td' ),
						'label_off' => esc_html__( 'Hide', 'bwdtbt-blogpost-td' ),
						'return_value' => 'yes',
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Autoplay TimeOut (ms)', 'bwdtbt-blogpost-td' ),
						'type' => \Elementor\Controls_Manager::NUMBER,
						'min' => 1,
						'max' => 100000,
						'step' => 1,
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Autoplay Speeds (ms)', 'bwdtbt-blogpost-td' ),
						'type' => \Elementor\Controls_Manager::NUMBER,
						'min' => 1,
						'max' => 100000,
						'step' => 1,
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Stage Padding (px)', 'bwdtbt-blogpost-td' ),
						'type' => \Elementor\Controls_Manager::NUMBER,
						'min' => 0,
						'max' => 100000,
						'step' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Navigation :: Arrow', 'bwdtbt-blogpost-td' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => esc_html__( 'Default', 'bwdtbt-blogpost-td' ),
				'label_on' => esc_html__( 'Custom', 'bwdtbt-blogpost-td' ),
				'return_value' => 'yes',
		...
		$this->start_popover();
			...
			$this->add_control(
				'bwdtbt_nav_switcher',
				[
					'label' => esc_html__( 'Arrow Navigation ?', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'bwdtbt-blogpost-td' ),
					'label_off' => esc_html__( 'Hide', 'bwdtbt-blogpost-td' ),
					'return_value' => 'yes',
			...
			$this->add_control(
				'bwdtbt_nav_type',
				[
					'label' => esc_html__( 'Arrow Type', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'icon',
					'options' => [
						'icon'  => esc_html__( 'Icon', 'bwdtbt-blogpost-td' ),
						'text'  => esc_html__( 'Text', 'bwdtbt-blogpost-td' ),
					],
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Previous Icon', 'bwdtbt-blogpost-td' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Next Icon', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::ICONS,
					'default' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Previous Text', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => esc_html__( 'Prev', 'bwdtbt-blogpost-td' ),
					'dynamic' => [
						'active' => true,
					],
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Next Text', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => esc_html__( 'Next', 'bwdtbt-blogpost-td' ),
					'dynamic' => [
						'active' => true,
					],
					'condition' => [
		...
		$this->add_control(
			'bwdtbt_dots_popover',
			[
				'label' => esc_html__( 'Navigation :: Dots', 'bwdtbt-blogpost-td' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => esc_html__( 'Default', 'bwdtbt-blogpost-td' ),
				'label_on' => esc_html__( 'Custom', 'bwdtbt-blogpost-td' ),
				'return_value' => 'yes',
		...
		$this->start_popover();
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Active Dots ?', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'bwdtbt-blogpost-td' ),
					'label_off' => esc_html__( 'Hide', 'bwdtbt-blogpost-td' ),
					'return_value' => 'yes',
			...
			$this->add_control(
				'bwdtbt_dots_type',
				[
					'label' => esc_html__( 'Type', 'bwdtbt-blogpost-td' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'dots',
					'options' => [
						'dots'  => esc_html__( 'Dots', 'bwdtbt-blogpost-td' ),
						'numbers'  => esc_html__( 'Numbers', 'bwdtbt-blogpost-td' ),
					],
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Dot Style', 'bwdtbt-blogpost-td' ),
					'type' => Controls_Manager::SELECT,
					'default' => '',
					'options' => [
						''  => esc_html__( 'Default', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots1'  => esc_html__( 'Style 1', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots2'  => esc_html__( 'Style 2', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots3'  => esc_html__( 'Style 3', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots4'  => esc_html__( 'Style 4', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots5'  => esc_html__( 'Style 5', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots6'  => esc_html__( 'Style 6', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots7'  => esc_html__( 'Style 7', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots8'  => esc_html__( 'Style 8', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots9'  => esc_html__( 'Style 9', 'bwdtbt-blogpost-td' ),
						'bwdtbt_dots10'  => esc_html__( 'Style 10', 'bwdtbt-blogpost-td' ),
					],
					'condition' => [
						'bwdtbt_dots_switcher' => 'yes',
	...
	protected function render() {
		...
		if('style1' === $settings['tbt_style_selection']){?>
			<div class="tbt-testimonial-two tbt-background-box bwdtbt-slider-common <?php echo esc_attr($settings['bwdtbt_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdtbt-blogpost-custom-id'] ); ?>">
				<?php require 'bwdeb-variable2.php' ; ?>
				<div class="container">
					<div class="tbt-testimonial-item-wrapper bwdtbt-owl bwdtbt-owl-carousel bwdtbt-owl-theme">
						...
						echo '<div class="tbt-testimonial-item elementor-repeater-item-' . esc_attr( $item['_id'] ) . '">'; ?>
							<i class="tbt-top-q tbt-left-icon-tbt <?php echo esc_attr( $item['tbt_content_icon_left']['value'] ); ?>"></i>
