...
class BWDEB_bwdWIwebinarinfo extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/webinar-info-addon-for-elementor" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'3' => esc_html__( 'Style 3', 'bwd-elementor-addons' ),
					'4' => esc_html__( 'Style 4', 'bwd-elementor-addons' ),
					'5' => esc_html__( 'Style 5', 'bwd-elementor-addons' ),
					'6' => esc_html__( 'Style 6', 'bwd-elementor-addons' ),
				]
			]
		);
		// choose count down style
    ...
    protected function render() {
		...
		if ( ! empty( $settings['bwdwi_webinar_info_bg_image']['url'] ) ) {
			$bgimg= esc_url($settings['bwdwi_webinar_info_bg_image']['url']);
		}

		if ( ! empty( $settings['bwdwi_webinar_info_content_image_extra']['url'] ) ) {
			$img= esc_url($settings['bwdwi_webinar_info_content_image_extra']['url']);
		}
		if ( ! empty( $settings['bwdwi_webinar_info_content_image_extra_two']['url'] ) ) {
			$imgTwo=esc_url( $settings['bwdwi_webinar_info_content_image_extra_two']['url']);
		}
		if ( ! empty( $settings['bwdwi_webinar_info_content_image_extra_three']['url'] ) ) {
			$imgThree= esc_url($settings['bwdwi_webinar_info_content_image_extra_three']['url']);
		}
		if ( ! empty( $settings['bwdwi_webinar_btn_link']['url'] ) ) {
			$this->add_link_attributes( 'bwdwi_webinar_btn_link', esc_url($settings['bwdwi_webinar_btn_link']) );
		}
