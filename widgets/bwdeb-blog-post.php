...
class BWDEB_BWDBPLBlog extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwdbpl_author-img img' => 'height: {{SIZE}}{{UNIT}} !important; width: {{SIZE}}{{UNIT}} !important;',
				],
				'condition' => [
					'bwdbpl_author_show_switcher' => 'yes',
		...
		// For Author Filter
		$bwdbpl_array = get_users();
		foreach ($bwdbpl_array as $bwdbpl_author){
			$bwdbpl_id = $bwdbpl_author->ID;
			$bwdbpl_name = $bwdbpl_author->display_name;
			$bwdbpl_get_array[$bwdbpl_id] = $bwdbpl_name;
		}
		$this->add_control(
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_desce' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_desce' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwdbpl_blog_image' => 'height: {{SIZE}}{{UNIT}}% !important; width: {{SIZE}}% !important;',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwdbpl_author img, {{WRAPPER}} .bwdbpl_author-img img' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'bwdbpl_author_indicator' => 'gravatar',
				]
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_user' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_user' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_date' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_date' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_comment' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_comment' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_tag' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_tag' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_category li a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_category li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_box' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_blog_bottom_part' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_box_padding_cmn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwdbpl_pagination_item' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwdbpl_pagination_item a, {{WRAPPER}} .bwdbpl_pagination_item span' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwdbpl_pagination_item a, {{WRAPPER}} .bwdbpl_pagination_item span' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'rem', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bwdbpl_pagination_item a, {{WRAPPER}} .bwdbpl_pagination_item span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->end_controls_section();
	...
	protected function render() {
		...
		$bwdbpl_cnt_align = $settings['bwdbpl_content_alignment'];
		if('left' === $bwdbpl_cnt_align){
			$bwdbpl_cont_align = 'bwdbpl_cnt_align_left bwdbpl_cnt_align_left_j';
		} elseif('center' === $bwdbpl_cnt_align){
			$bwdbpl_cont_align = 'bwdbpl_cnt_align_center bwdbpl_cnt_align_center_j';
		} elseif('right' === $bwdbpl_cnt_align){
			$bwdbpl_cont_align = 'bwdbpl_cnt_align_right bwdbpl_cnt_align_right_j';
		} else{ $bwdbpl_cont_align = ' '; }
		...
		$bwdbpl_categorys_dataa = $settings['bwdbpl_the_cat_columnsdd'];
		$bwdbpl_the_blog_type = $settings['bwdbpl_the_blog_type'];
		...
		$bwdbpl_the_pagination_items_align = $settings['bwdbpl_the_pagination_items_align'];
		if('filter_left' === $bwdbpl_the_pagination_items_align){
			$bwdbpl_pagination_position = 'text-start';
		} elseif('filter_center' === $bwdbpl_the_pagination_items_align){
			$bwdbpl_pagination_position = 'text-center';
		} elseif('right' === $bwdbpl_the_pagination_items_align){
			$bwdbpl_pagination_position = 'text-end';
		} else{ $bwdbpl_pagination_position = ''; }
		...
		if($bwdbpl_styles == 'style1' || $bwdbpl_styles == 'style2'){
			include( __DIR__ . '/pltemplates/'.$bwdbpl_styles.'.php' );
		}else{
			echo '<h1 class="bwd_pro_notice">'.esc_html__('Ohh!!! It\'s ', 'bwd-elementor-addons').'<a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>'.esc_html__(' PRO...', 'bwd-elementor-addons').'</b></a></h1>';
		}
	}
	public function bwdbpl_post_categories() {
        $bwdbpl_categories_list = get_the_category_list(', ');
        if ($bwdbpl_categories_list) {
            echo esc_html($bwdbpl_categories_list);
        }
    }
	public function bwdbpl_post_thumbnail_here(){
		?>
		<a class="bwdbpl_imgnot" href="<?php echo esc_url(get_permalink()); ?>" style="text-decoration:none;">
		<?php 
	...
	public function bwdbpl_post_thumbnail_with_css(){
		$bwdbpl_thumbnail = wp_get_attachment_image_src(get_post_thumbnail_id(), 'large');
		list($bwdbpl_thumbnail_url) = $bwdbpl_thumbnail;
		if(has_post_thumbnail()){
		?>
		<div class="bwdbpl_blog_image bwdbpl_image_overly_b bwdbpl_image_overly_a" style="background-image: url(<?php echo esc_url($bwdbpl_thumbnail_url); ?>);"><a class="blog_img-link" href="<?php echo esc_url(get_permalink()); ?>"></a>
		<?php
		} else{
			echo '<div class="bwdbpl_text_no bwdbpl_blog_image bwdbpl_image_overly_b bwdbpl_image_overly_a text-center ">' . esc_html__('No Thumbnail', 'bwd-elementor-addons');
		}
	}
}
