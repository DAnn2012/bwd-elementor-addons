                                    ...
                                    <div class="bwdpc-profile-card-item">
                                        ...
                                        <div class="bwdpc-profile-card-share-link">
                                            <?php
												...
												href="<?php echo  esc_url( $icon_item['bwdpc_profile_icon_link']['url'] );?>"><?php echo '<i class="'.esc_attr($icon_item['bwdpc_profile_box_icon']).'"></i>';//\Elementor\Icons_Manager::render_icon( esc_attr($icon_item['bwdpc_profile_box_icon']), [ 'aria-hidden' => 'true' ] ); ?></a>
												<?php 
													}
                                            } ?>
                                        </div><?php } ?>
                                    ...
                                    <div class="bwdpc-profile-card-item">
                                        ...
                                        <div class="bwdpc-profile-card-share-link">
                                            <?php
												...
												?>
												<a class="bwdpc-socialIcon elementor-repeater-item-<?php echo esc_attr( $icon_item['_id'] ); ?>" 
												href="<?php echo  esc_url( $icon_item['bwdpc_profile_icon_link']['url'] );?>"><?php \Elementor\Icons_Manager::render_icon( esc_attr($icon_item['bwdpc_profile_box_icon']), [ 'aria-hidden' => 'true' ] ); ?></a>
												<?php 
													}
                                            } ?>
                                        </div><?php } ?>
