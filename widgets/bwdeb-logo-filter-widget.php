...
class BWDEB_BWDLCLogoFilter extends Widget_Base {
	...
	public function get_name() {
		return esc_html__('Bwd_logo_Filter', 'bwd-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/brand-logo-showcase" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		$this->add_control(
