...
class BWDEB_BWDDHHeading extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/dual-heading-addon-for-elementor/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
	...
	protected function render() {
		...
		if ( ! empty( $settings['bwddh_heading_title_url']['url'] ) ) {
			$this->add_link_attributes( 'bwddh_heading_title_url', esc_url($settings['bwddh_heading_title_url']) );
		}
