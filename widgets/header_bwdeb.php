...
class BWDEB_THFTheHeader extends Widget_Base {
	...
	public function get_icon() {
		return 'bwdeb-elementor-bundle icon-header';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/elementor-header" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
	...
	protected function render() {
		...
		if ( ! empty( $settings['thf_header_footer_button_link']['url'] ) ) {
			$this->add_link_attributes( 'thf_header_footer_button_link', esc_url($settings['thf_header_footer_button_link']) );
		}
		
		$thf_header_style = $settings['thf_header_footer_styles'];
		if(true){$thf_choose_the_menu = $settings['thf_choose_main_menu'];}else{$thf_choose_the_menu = ' '; }
