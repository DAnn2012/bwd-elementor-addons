	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/social-share" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		$this->add_control(
				...
				echo '<div class="main-container">';
					foreach (  $settings['usshare_all_social_btn'] as $usshare_btn ) {
						...
						echo '<div class="usshare_btn_link_wrap elementor-repeater-item-' . esc_attr( $usshare_btn['_id'] ) . '">';
							?><a class="usshare_btn_link <?php echo esc_attr($social_cont); ?> <?php echo esc_attr($icon_pos); ?>" href="<?php echo esc_url($usshare_Alink); ?>" onclick="window.open(this.href, '_blank', 'width=400,height=400,left='+screen.width/2.5+',top='+screen.height/3); return false;"><?php
							if($usshare_btn['usshare_icon_content_type'] === 'icontext') :
								\Elementor\Icons_Manager::render_icon( esc_attr($usshare_btn['usshare_social_iconstext']), [ 'aria-hidden' => 'true' ] ); 
								echo esc_html($social_icon_text);
							elseif($usshare_btn['usshare_icon_content_type'] === 'icon') :	
							\Elementor\Icons_Manager::render_icon( esc_attr($usshare_btn['usshare_social_icons']), [ 'aria-hidden' => 'true' ] ); 
