...
class BWDEB_BWDAHAnimatedHeadingWidget extends Widget_Base {
	...
	public function get_name() {
		return esc_html__( 'BWD Animated Heading', 'bwd-elementor-addons');
	}
     ...
     // animated heading layout control section start
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/animated-heading/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		// typing category
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://www.bwdplugins.com/bwd-animated-heading/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
				'condition' => [
