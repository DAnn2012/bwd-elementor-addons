...
class BWDEB_CBTNSCreativeButtons extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/creative-button/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		$this->add_control(
			'cbtns_text_buttons', [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'cbtns-left' => esc_html__( 'Left', 'bwd-elementor-addons' ),
					'cbtns-center' => esc_html__( 'Center', 'bwd-elementor-addons' ),
					'cbtns-right' => esc_html__( 'Right', 'bwd-elementor-addons' ),
				],
			]
		);
	...
	protected function render() {
		...
		if ( ! empty( $settings['cbtns_link_buttons']['url'] ) ) {
			$this->add_link_attributes( 'cbtns_link_buttons', esc_url($settings['cbtns_link_buttons']) );
		}
		?>
		<?php
		...
		if('cbtns-right' === $settings['cbtns_alignment_buttons']){
			...
			<div class="cbtns-btn-one cbtns_creative_buttons <?php echo esc_attr($settings['cbtns_buttons_custom_class_id']); ?>">
				<a href="<?php echo esc_url($settings['cbtns_link_buttons']['url']); ?>"><div class="cbtns-title"><?php echo esc_html($settings['cbtns_text_buttons']); ?></div></a>
			</div>
			<?php
			...
			<div class="cbtns-btn-two cbtns_creative_buttons <?php echo esc_attr($settings['cbtns_buttons_custom_class_id']); ?>">
				...
				<div class="cbtns-title"><?php echo esc_html($settings['cbtns_text_buttons']); ?></div>
