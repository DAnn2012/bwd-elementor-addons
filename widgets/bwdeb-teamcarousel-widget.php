					...
					echo '<div class="bwdtmc-col elementor-repeater-item-' . esc_attr( $item['_id'] ) . '">'; ?>
						<div class="bwdtmc-team bwdtmc-total-team-box">
							...
							<div class="bwdtmc-social">
								<?php if('yes' === $item['bwdtmc_social_icon_one_switcher']){ ?><a class="bwdtmc-social-icon-one" href="<?php echo esc_url($item['bwdtmc_social_icon_one_link']['url']); ?>"><?php \Elementor\Icons_Manager::render_icon( esc_attr($item['bwdtmc_social_icon_one']), [ 'aria-hidden' => 'true' ] ); ?></a> <?php } ?>
								<?php if('yes' === $item['bwdtmc_social_icon_two_switcher']){ ?><a class="bwdtmc-social-icon-two" href="<?php echo esc_url($item['bwdtmc_social_icon_two_link']['url']); ?>"><?php \Elementor\Icons_Manager::render_icon( esc_attr($item['bwdtmc_social_icon_two']), [ 'aria-hidden' => 'true' ] ); ?></a> <?php } ?>
								<?php if('yes' === $item['bwdtmc_social_icon_three_switcher']){ ?><a class="bwdtmc-social-icon-three" href="<?php echo esc_url($item['bwdtmc_social_icon_three_link']['url']); ?>"><?php \Elementor\Icons_Manager::render_icon( esc_attr($item['bwdtmc_social_icon_three']), [ 'aria-hidden' => 'true' ] ); ?></a> <?php } ?>
								<?php if('yes' === $item['bwdtmc_social_icon_four_switcher']){ ?><a class="bwdtmc-social-icon-four" href="<?php echo esc_url($item['bwdtmc_social_icon_four_link']['url']); ?>"><?php \Elementor\Icons_Manager::render_icon( esc_attr($item['bwdtmc_social_icon_four']), [ 'aria-hidden' => 'true' ] ); ?></a> <?php } ?>
							</div>
						</div>
					</div>
					<?php
							...
							<div class="bwdtmc-our-team-item">
								...
								<div class="bwdtmc-team-content bwdtmc_team_profile_background">
									...
									<div class="bwdtmc-social">
										...
										<?php if('yes' === $item['bwdtmc_social_icon_two_switcher']){ ?><a class="bwdtmc-social-icon-two" href="<?php echo esc_url($item['bwdtmc_social_icon_two_link']['url']); ?>"><?php \Elementor\Icons_Manager::render_icon( esc_attr($item['bwdtmc_social_icon_two']), [ 'aria-hidden' => 'true' ] ); ?></a> <?php } ?>
										<?php if('yes' === $item['bwdtmc_social_icon_three_switcher']){ ?><a class="bwdtmc-social-icon-three" href="<?php echo esc_url($item['bwdtmc_social_icon_three_link']['url']); ?>"><?php \Elementor\Icons_Manager::render_icon( esc_attr($item['bwdtmc_social_icon_three']), [ 'aria-hidden' => 'true' ] ); ?></a> <?php } ?>
										<?php if('yes' === $item['bwdtmc_social_icon_four_switcher']){ ?><a class="bwdtmc-social-icon-two" href="<?php echo esc_url($item['bwdtmc_social_icon_four_link']['url']); ?>"><?php \Elementor\Icons_Manager::render_icon( esc_attr($item['bwdtmc_social_icon_four']), [ 'aria-hidden' => 'true' ] ); ?></a> <?php } ?>
									</div>
								</div>
							</div>
						</div>
