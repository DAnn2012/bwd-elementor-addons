...
class BWDEB_BWDPTPricingTable extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/pricing-table-addon-for-elementor/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
    ...
    protected function render() {
		...
		if ( ! empty( $settings['bwdpt_pricing_table_btn_link']['url'] ) ) {
			$this->add_link_attributes( 'bwdpt_pricing_table_btn_link', esc_url($settings['bwdpt_pricing_table_btn_link']) );
		}
