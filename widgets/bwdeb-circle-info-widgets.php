    ...
    protected function register_controls(){
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/interactive-circle-infographic" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
						...
						?>
							<div class="bwdci-ep-circle-info-sub-circle elementor-repeater-item-<?php echo esc_attr( $repet_circle['_id'] ); ?>">
								<?php if ( $repet_circle['bwdci_icon_yes_no'] == 'icon' )  : ?>
									<div class="bwdci-icon-circle"><?php echo '<i class="'.esc_attr($repet_circle['bwdci_button_icon']).'"></i>'; ?></div>
								<?php endif; ?>
