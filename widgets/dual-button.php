...
class BWDEB_BWDDBDualButtons extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/dual-button-addon-for-elementor/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( ! empty( $settings['bwddb_first_link_buttons']['url'] && $settings['bwddb_secound_link_buttons']['url'] ) ) {
			$this->add_link_attributes( 'bwddb_first_link_buttons', esc_url($settings['bwddb_first_link_buttons']) );
			$this->add_link_attributes( 'bwddb_secound_link_buttons', esc_url($settings['bwddb_secound_link_buttons']) );
		}
