...
class BWDEB_EPREL_Effective_widgets extends Widget_Base {
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/pre-loader" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		$repeater->add_control(
			'plcprecentagelayout',
	...
	protected function render() {
		...
		if(!empty($preLoaderContent)) {
			...
			echo wp_kses_post($preloaderSrc);
		}
	}
}