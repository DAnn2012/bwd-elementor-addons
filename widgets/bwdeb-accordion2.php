	...
	protected function register_controls() {
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .ab-panel-title .ab-collapsed' => 'padding-left: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);
		$repeater->add_responsive_control(
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .ab-panel-title .ab-collapsed:hover' => 'padding-left: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);
		$repeater->end_controls_tab();
		...
		$repeater->add_responsive_control(
            ...
            [
				...
				'size_units' => ['px', 'rem', 'em'],
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .ab-panel-body .ab-inner-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
				'condition' => [
					'ab_accordion_inner_title_show' => 'yes',
				],
		...
		$repeater->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .ab-inner-desc ul' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
                ],
            ]
        );
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .ab-inner-desc ul li' => 'padding-left: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);
		$repeater->add_responsive_control(
		...
		$repeater->add_responsive_control(
            ...
            [
				...
				'size_units' => ['px', 'rem', 'em'],
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .ab-panel-body .ab-inner-desc' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
				'condition' => [
					'ab_accordion_inner_desc_show' => 'yes',
				],
		...
		$repeater->add_responsive_control(
            ...
            [
				...
				'size_units' => ['px', 'rem', 'em'],
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .ab-panel-body .ab-inner-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
				'condition' => [
					'ab_accordion_inner_btn_show' => 'yes',
				],
		...
		$repeater->add_responsive_control(
            ...
            [
				...
				'size_units' => ['px', 'rem', 'em'],
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .ab-panel-body .ab-inner-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
				'condition' => [
					'ab_accordion_inner_btn_show' => 'yes',
				],
		...
		$repeater->add_responsive_control(
            ...
            [
				...
				'size_units' => ['px', 'rem', 'em'],
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .ab-panel-body' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$repeater->end_controls_tab();
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .ab-collapsed-icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$repeater->end_controls_tab();
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .ab-expand-icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$repeater->end_controls_tab();
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					' {{WRAPPER}} {{CURRENT_ITEM}} .ab-collapsed-icon svg, {{WRAPPER}} {{CURRENT_ITEM}} .ab-expand-icon svg' => 'width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		$repeater->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'ab_total_box_title' => esc_html__( 'Accordion #1', 'bwd-elementor-addons' ),
					],
					[
						'ab_total_box_title' => esc_html__( 'Accordion #2', 'bwd-elementor-addons' ),
					],
					[
						'ab_total_box_title' => esc_html__( 'Accordion #3', 'bwd-elementor-addons' ),
					],
					[
						'ab_total_box_title' => esc_html__( 'Accordion #4', 'bwd-elementor-addons' ),
					],
				],
					...
					foreach (  $settings['ab_total_accordion_box'] as $item ) {
						...
						<div class="ab-Accordion-heading" >
							<h4 class="ab-panel-title">
								<span class="ab-collapsed"><?php echo esc_html($item['ab_accordion_title']); ?></span>
								<span class="ab-collapsed-icon"><?php 
									echo '<i class="'.esc_attr($item['ab_accordion_collapsed_icon']).'"></i>';
								?></span>
								<span class="ab-expand-icon"><?php 
									echo '<i class="'.esc_attr($item['ab_accordion_expand_icon']).'"></i>';
								?></span>
							</h4>
						</div>
						<div id="collapseOne">
								...
								<div class="ab-panel-content-wrapper">
									...
									<div class="ab-content-wrap">
										...
										<?php if($item['ab_accordion_inner_desc_show'] === 'yes') { ?>
											<div class="ab-inner-desc"><?php echo esc_html($item['ab_accordion_description']); ?></div>
										<?php } ?>
										<?php if($item['ab_accordion_inner_btn_show'] === 'yes') { ?>
											<div class="ab-inner-btn-wrap">
												<a href="<?php echo esc_url( $item['ab_accordion_inner_btn_link']['url']); ?>" class="ab-inner-btn"><?php echo esc_attr($item['ab_accordion_inner_btn_text']); ?></a>
											</div>
										<?php } ?>
									</div>
								</div>
